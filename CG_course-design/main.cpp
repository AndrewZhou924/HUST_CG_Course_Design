...
int main()
{
	...
	// Load font as face
	FT_Face face;
	if (FT_New_Face(ft, "fonts/Expansiva.otf", 0, &face))
	...
	unsigned int ballTexture = loadTexture("./res/textures/window.png");


	// temp flags and timer
	int num_ball = 0;
	int flag_ball = 0;
	int BALL_MAX = 1000000000;
	int modelRotate = 1;
	int times_model = 0;
	int times2_model = 0;
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		if (flagForText == 1)
		{
			...
			RenderText(textShader, "made by zhanke zhou", 50.0f, 100.0f, 1.0f, glm::vec3(0.9, 0.9f, 0.9f));
			RenderText(textShader, "advanture begins", 510.0f, 570.0f, 1.5f, glm::vec3(0.3, 0.7f, 0.9f));
