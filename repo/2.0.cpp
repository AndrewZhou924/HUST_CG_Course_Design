...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		if (flagForText == 1)
		{
		    ...
		    RenderText(shader, "made by zhanke zhou", 50.0f, 100.0f, 1.0f, glm::vec3(0.9, 0.9f, 0.9f));
		    RenderText(shader, "mission completed", 510.0f, 570.0f, 1.5f, glm::vec3(0.3, 0.7f, 0.9f));
