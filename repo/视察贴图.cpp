...
void renderQuad()
{
	...
	{
		// positions
		glm::vec3 pos3(1.0f, -3.8f, 1.0f);
		glm::vec3 pos4(-1.0f, -3.8f, 1.0f);
		glm::vec3 pos1(-1.0f, -3.8f, -1.0f);
		glm::vec3 pos2(1.0f, -3.8f, -1.0f);
		...
		//glm::vec3 pos1(0.0f, 1.0f, -1.0f);
		//glm::vec3 pos2(0.0f, -1.0f, -1.0f);
		//glm::vec3 pos3(0.0f, -1.0f, 1.0f);
		//glm::vec3 pos4(0.0f, 1.0f, 1.0f);
